			...
			<div class="modal fade" id="HeaderFlist" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				<div class="modal-dialog  modal-sm" role="document">
					<div class="modal-content">
						<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title" id="myModalLabel">Header Atau Itemset</h4>
						</div>
						<div class="modal-body">
							<table border="1" class="table table-striped">
								<th>ID ITEM<th>FP Tree
									<?php
										$minsup = $_POST['opt1'];
										$header = $minsup*$jml;
						...
						<div class="modal-body">
							<table border='1' class="table table-striped"> 
											...
											if(in_array(0,$d) && in_array(3,$d) && in_array(4,$d))
											{
												...
												$item = "Nama & Jenis Kelamin => Asal Sekolah";
												$benchmark = $itemconsequent/$jml;
												$liftratio = $confidence/$benchmark;
												$liftratio = number_format($liftratio,2);
												$spesifikasi = "Jika memilih item Nama dan Jenis Kelamin maka akan memilih Asal Sekolah";
												echo "<tr>";
											...
											if(in_array(0,$d) && in_array(3,$d) && in_array(1,$d))
											{
												...
												$confidence = (($kondisi_count_transaksi/$sqla)*100)/100;
												$confidence = number_format($confidence,2);
												$item = "Nama & Jenis Kelamin => Agama";
												$benchmark = $itemconsequent/$jml;
												$liftratio = $confidence/$benchmark;
												$liftratio = number_format($liftratio,2);
												$spesifikasi = "Jika memilih item Nama dan Jenis Kelamin maka akan memilih Agama";
												echo "<tr>";
											...
											if(in_array(0,$d) && in_array(1,$d))
											{
												...
												$confidence = (($kondisi_count_transaksi/$sqla)*100)/100;
												$confidence = number_format($confidence,2);
												$item = "Asal Sekolah & Tempat Tinggal Asal";
												$benchmark = $itemconsequent/$jml;
												$liftratio = $confidence/$benchmark;
												$liftratio = number_format($liftratio,2);
												$spesifikasi = "Jika memilih item Asal Sekolah maka akan memilih Tempat Tinggal Asal";
												echo "<tr>";
												echo "<td>Rule 1 => 2</td>";
												echo "<td>".$kondisi_count_transaksi."</td>";
												echo "<td>".$support."</td>";
											...
											if(in_array(5,$d) && in_array(0,$d))
											{
												...
												$confidence = (($kondisi_count_transaksi/$sqla)*100)/100;
												$confidence = number_format($confidence,2);
												$item = "Pekerjaan & Tempat Tingal Sekarang";
												$benchmark = $itemconsequent/$jml;
												$liftratio = $confidence/$benchmark;
												$liftratio = number_format($liftratio,2);
												$spesifikasi = "Jika memilih item Pekerjaan maka akan Tempat Tinggal Sekarang";
												echo "<tr>";
											...
											if(in_array(4,$d) && in_array(0,$d))
											{
												...
												$liftratio = $confidence/$benchmark;
												$liftratio = number_format($liftratio,2);
												$spesifikasi = "Jika memilih item Nama maka akan memilih Nid";
												echo "<tr>";
												echo "<td>Rule 5 => 1</td>";
												echo "<td>".$kondisi_count_transaksi."</td>";
												echo "<td>".$support."</td>";
											...
											if(in_array(2,$d) && in_array(0,$d))
											{
												...
												$confidence = (($kondisi_count_transaksi/$sqla)*100)/100;
												$confidence = number_format($confidence,2);
												$item = "Wilayah & Asal Sekolah";
												$benchmark = $itemconsequent/$jml;
												$liftratio = $confidence/$benchmark;
												$liftratio = number_format($liftratio,2);
												$spesifikasi = "Jika memilih item Wilayah maka akan memilih Asal Sekolah";
												echo "<tr>";
												echo "<td>Rule 3 => 1</td>";
												echo "<td>".$kondisi_count_transaksi."</td>";
												echo "<td>".$support."</td>";
											...
											if(in_array(3,$d) && in_array(0,$d))
											{
												...
												$confidence = (($kondisi_count_transaksi/$sqla)*100)/100;
												$confidence = number_format($confidence,2);
												$item = "Pekerjaan Orang Tua & Nama";
												$benchmark = $itemconsequent/$jml;
												$liftratio = $confidence/$benchmark;
												$liftratio = number_format($liftratio,2);
												$spesifikasi = "Jika memilih item Pekerjaan orang tua maka akan memilih Nama";
												echo "<tr>";
												echo "<td>Rule 4 => 1</td>";
												echo "<td>".$kondisi_count_transaksi."</td>";
												echo "<td>".$support."</td>";
			...
			<div class="modal fade" id="Hasil" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				<div class="modal-dialog  modal-lg" role="document">
					<div class="modal-content">
						<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title" id="myModalLabel">Association Rule</h4>
						</div>
						<div class="modal-body">
							<table border='1' class="table table-striped"> 
											<thead>
